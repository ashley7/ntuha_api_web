...
<head>
    ...
    <link rel="shortcut icon" href="/front/images/ntuha.png">
    <!--[if lt IE 9]>
...
<body class="homepage">
    ...
    <section id="main-slider" class="no-margin">
        <div class="carousel slide">
            ...
            <div class="carousel-inner">
                ...
                <div class="item active" style="background-color: #35D073">
                    <div class="container">
                        <div class="row slide-margin">
                            ...
                            <div class="col-sm-6 hidden-xs animation animated-item-4">
                                <div class="slider-img">
                                    <img src="/front/img/farmer_one.jpg" class="img-responsive">
                                </div>
                            </div>
                ...
                <div class="item" style="background-color: #35D073">
                    <div class="container">
                        <div class="row slide-margin">
                            <div class="col-sm-6">
                                <div class="carousel-content">
                                    <h1 class="animation animated-item-1">Farmer requests for reliable means of transport for the goods to the market</h1></div>
                            </div>

                            <div class="col-sm-6 hidden-xs animation animated-item-4">
                                <div class="slider-img">
                                    <img src="/front/img/farmertwo.PNG" class="img-responsive">
                                </div>
                            </div>
    ...
    <section id="aboutus" class="service-item">
     ...
     <section id="services" class="service-item">
       <div class="container">
            <div class="center wow fadeInDown">
                <h2><font color="#000">Areas of Operation</font></h2>
                <p class="lead"><b><font color="#000">Mbarara</font></b><br>
                <font color="#000">Ntuha currently runs its operations in Mbarara town with offices at Bam complex Building. The Mbarara office is the headquarters of Ntuha and offers online logistics and package delivery services to both drivers and commuters in Mbarara and surrounding areas.
                Physical Address: Bam Complex Building, High street.</font> <br>
                <font color="#000">Email:</font> <a href="mailto">ntuha.deliveries@gmail.com</a><br>
                <font color="#000">Tel: +256 (0) 704 444 481 or +256 (0) 703 03 7087</font>
                <br>

                <i><b style="color: #000"><hr>Offices Opening up soon!<hr/></b></i>
                <br>

                <b style="color: #000">Kabale Office</b><br>
                <p style="color: #000">
                ...
                <br>
                <b style="color: #000">Karamoja and Northern Uganda office</b><br>
                <p style="color: #000">
            ...
            <center>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <ul>
                            <li>Access to farmers</li>
                            <li>Access to bumper harvest information</li>
                            <li>Buys directly from farmers</li>                            
                        </ul>
                    </div>
